...
ivPKde = function(t, y, p)
{
  ...
  CL = p["Vmax"]/(p["Km"] + y[4])                                      ## Non-linear diff. eq. ----
...
fPK09 = function(THETA)
{
  ...
  Fs1 = lsoda(y=c(0, 0, 0, 0), times=Times1, func=ivPKde, parms=c(Ka=Ka, Vc=Vc, Vt=Vt, Km=Km, Vmax=Vmax, Cld=Cld, Tlag=Tlag), hmax = 1)
